...
public class ScriptedBuildOrderManager implements IBuildOrderManager {
	...
	private Build vsTerran() {
		if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Probe) < 8){
			...
			return new Build(UnitType.Protoss_Pylon);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountInProd(UnitType.Protoss_Zealot) + ITUBot.getInstance().informationManager.ownUnitCountInProd(UnitType.Protoss_Dragoon) < ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Gateway)){
		...
		} else if (ITUBot.getInstance().informationManager.ownUnitCountInProd(UnitType.Protoss_Probe) < ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Nexus)){
			return new Build(UnitType.Protoss_Probe);
		...
		} else if (ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Zealot) > 7 && ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Probe) > 13*ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Nexus)){
			return new Build(UnitType.Protoss_Nexus);
		...
		} else if (ITUBot.getInstance().informationManager.ownUpgradeCountTotal(UpgradeType.Singularity_Charge) == 0){
			return new Build(UpgradeType.Singularity_Charge);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Observatory) < 1){
			return new Build(UnitType.Protoss_Observatory);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Observer) < 2){
		...
		} else if (ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Photon_Cannon) < 1*ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Nexus)){
			return new Build(UnitType.Protoss_Photon_Cannon);
		} else if (ITUBot.getInstance().informationManager.ownUpgradeCountTotal(UpgradeType.Protoss_Ground_Weapons) == 0 && ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Forge) >= 1){
			return new Build(UpgradeType.Protoss_Ground_Weapons);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Gateway) < 3){
			return new Build(UnitType.Protoss_Gateway);
		...
		} else if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Gateway) < 4){
			return new Build(UnitType.Protoss_Gateway);
		...
		} else if (ITUBot.getInstance().informationManager.ownTechCountTotal(UpgradeType.Leg_Enhancements) < 1){
		...
		} else if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Gateway) < 5){
			return new Build(UnitType.Protoss_Gateway);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountInProd(UnitType.Protoss_Arbiter) < 1){
			return new Build(UnitType.Protoss_Arbiter);
		} else if (ITUBot.getInstance().informationManager.ownUpgradeCount(UpgradeType.Protoss_Ground_Weapons) == 1){
			return new Build(UpgradeType.Protoss_Ground_Weapons);
		} else if (ITUBot.getInstance().informationManager.ownUpgradeCount(UpgradeType.Protoss_Ground_Armor) == 1){
			return new Build(UpgradeType.Protoss_Ground_Armor);
		} else if (ITUBot.getInstance().informationManager.ownTechCount(TechType.Stasis_Field) == 1){
			return new Build(TechType.Stasis_Field);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Gateway) < 6){
			return new Build(UnitType.Protoss_Gateway);
		} else {
			return new Build(UnitType.Protoss_Probe);
		}
	...
	private Build vsProtoss() {
		if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Probe) < 8){
			...
			return new Build(UnitType.Protoss_Forge);
		} else if (ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Photon_Cannon) < 2*ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Nexus)){
			return new Build(UnitType.Protoss_Photon_Cannon);
		} else if (ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Zealot) > 7 && ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Probe) > 13*ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Nexus)){
			return new Build(UnitType.Protoss_Nexus);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Robotics_Facility) < 1){
			...
			return new Build(UnitType.Protoss_Observer);
		} else if (ITUBot.getInstance().informationManager.ownUpgradeCountTotal(UpgradeType.Protoss_Ground_Weapons) == 0){
			return new Build(UpgradeType.Protoss_Ground_Weapons);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Gateway) < 3){
			return new Build(UnitType.Protoss_Gateway);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Robotics_Support_Bay) < 1){
	...
	private Build vsZerg() {
		if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Probe) < 8){
			...
			return new Build(UnitType.Protoss_Cybernetics_Core);
		} else if (ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Zealot) > 3 && ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Probe) > 13*ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Nexus)){
			return new Build(UnitType.Protoss_Nexus);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Forge) < 1){
			return new Build(UnitType.Protoss_Forge);
		} else if (ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Photon_Cannon) < 2*ITUBot.getInstance().informationManager.ownUnitCount(UnitType.Protoss_Nexus)){
			...
			return new Build(UnitType.Protoss_Stargate);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountInProd(UnitType.Protoss_Corsair) < 1){
			return new Build(UnitType.Protoss_Corsair);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountTotal(UnitType.Protoss_Robotics_Support_Bay) < 1){
			return new Build(UnitType.Protoss_Robotics_Support_Bay);
		} else if (ITUBot.getInstance().informationManager.ownUnitCountInProd(UnitType.Protoss_Reaver) < 1){
			return new Build(UnitType.Protoss_Reaver);
